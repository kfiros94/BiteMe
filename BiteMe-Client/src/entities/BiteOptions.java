...
public class BiteOptions implements Serializable{
	...
	public enum Option{
		...
		SEND_PAYMENT, ORDER_SUMMARY, LOGIN_COMPANY, LOGIN_RESTAURANT,SHOW_MENU_RESTAURANT, 
		...
		ORDER_RECIEVED_BY_COSTUMER,DELETE_ITEM_MENU, UPDATE_MENU, INCOME_REPORT_GENERATION, ORDER_REPORT_GENERATION,
