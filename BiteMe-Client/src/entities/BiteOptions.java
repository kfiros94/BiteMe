...
public class BiteOptions implements Serializable{
	...
	public enum Option{
		LOGIN, LOGOUT,SELECT_RESTAURANT, CREATE_ORDER, DELETE_ORDER, RETRIEVE_ORDER_LIST, RETRIEVE_MANAGE_ORDER_LIST, REGISTER_USER,
		SEND_PAYMENT, ORDER_SUMMARY, LOGIN_COMPANY, LOGIN_RESTAURANT,SHOW_MENU_RESTAURANT,DELETE_ITEM_MENU, 
		...
		SIMULTANEOUS_VIEW_PAST_QUARTERLY_REPORT_CEO, GENERATE_NEW_REPORTS_FOR_CEO, IMPORT_NEW_USERS, GET_USER_FOR_NOTIFICATION, CHANGE_ORDER_STATUS;//We may add more options
	}
