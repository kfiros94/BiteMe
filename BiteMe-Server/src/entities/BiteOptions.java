...
public class BiteOptions implements Serializable{
	...
	public enum Option{
		...
		SIMULTANEOUS_VIEW_PAST_QUARTERLY_REPORT_CEO, GENERATE_NEW_REPORTS_FOR_CEO, IMPORT_NEW_USERS,GET_DISCOUNT_COUNT,UPDATE_DISCOUNT_COUNT,INCREMENT_DISCOUNT_COUNT;//We may add more options
	}
	/**
