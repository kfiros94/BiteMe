...
public class BiteOptions implements Serializable{
	 ...
	 */
	public enum Option{
		DELETE_ITEM_MENU,SHOW_MENU_RESTAURANT,LOGIN, LOGOUT,SELECT_RESTAURANT,TEST_JSON,GET_SELECTED_REST_MENU, BACK_HOME_CUSTOMER_PAGE, CREATE_ORDER,GET_USER_ORDERS,UPDATE_ORDER_STATUS_CUSTOMER, DELETE_ORDER, RETRIEVE_ORDER_LIST, REGISTER_USER,
