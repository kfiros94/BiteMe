...
public class BiteOptions implements Serializable{
	 ...
	 */
	public enum Option{
		LOGIN, LOGOUT,SELECT_RESTAURANT, CREATE_ORDER, DELETE_ORDER, RETRIEVE_ORDER_LIST, REGISTER_USER,
		...
		SIMULTANEOUS_VIEW_PAST_QUARTERLY_REPORT_CEO, GENERATE_NEW_REPORTS_FOR_CEO, IMPORT_NEW_USERS, FETCH_INCOME_REPORTS,FETCH_ORDER_REPORTS,FETCH_PERFORMANCE_REPORTS;//We may add more options
	}
